...
INSERT INTO _migrations VALUES('20240128_add_sentencenote.sql');
INSERT INTO _migrations VALUES('20240128_add_unique_index_sentencenote.sql');
INSERT INTO _migrations VALUES('20240129_modify_sentencenote_SeNtText.sql');
...
INSERT INTO languages VALUES(9,'Japanese','/dict/jp?word=###','https://www.bing.com/images/search?q=###&form=HDRSC2&first=1&tsc=ImageHoverTitle','*https://www.deepl.com/translator#jp/en/###','´=''|`=''|’=''|‘=''|...=…|..=‥','.!?。？！','Mr.|Mrs.|Dr.|[A-Z].|Vd.|Vds.','\p{Han}\p{Katakana}\p{Hiragana}',0,0,0,1,'japanese');
...
INSERT INTO texts VALUES(24,16,1,replace(replace('\r\n魯さんは無錫のひとです。李さんはシャンハイの人じゃない。\r\n今日は国慶節です。とてもよいてんきです。それで李さんと魯さんはワイタンへ行きます。\r\nワイタンはこうほこうのにしにあります。そのえいごめいはバンドです。\r\nワイタンはエキゾチックなところです。そこにはがいこくのふるいたてものがたくさんあります。\r\nワイタンのむこうがわはほとうです。こうほこうのひがいこあります。\r\nそこにはげんだいのあたらい、たてものがたくさんあります。\r\nワイタンのれきしぶんかとほとうのげんだいふうけいのコントラストはなかなかよいです','\r',char(13)),'\n',char(10)),NULL,113);
INSERT INTO texts VALUES(25,17,1,'Hola tengo un gato.',NULL,4);
...
INSERT INTO settings VALUES('unidic_types','user','writing');
INSERT INTO settings VALUES('show_reading','user','1');
...
INSERT INTO books VALUES(6,4,'Tutorial',NULL,0,7,NULL,NULL,NULL);
...
INSERT INTO books VALUES(13,9,'北風と太陽 - きたかぜたいよう',NULL,0,21,NULL,NULL,NULL);
INSERT INTO books VALUES(14,8,'Universal Declaration of Human Rights',NULL,0,0,NULL,NULL,NULL);
INSERT INTO books VALUES(16,9,'１１','',0,24,NULL,NULL,NULL);
INSERT INTO books VALUES(17,12,'test','',0,25,NULL,NULL,NULL);
...
CREATE TABLE IF NOT EXISTS "sentencenote"
(
