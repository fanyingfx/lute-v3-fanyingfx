...
from lute.bookimage.routes import bp as bookimage_bp
...
from lute.sentence.routes import bp as snote_bp
...
def _create_app(app_config, extra_config):
    ...
    app.register_blueprint(bookimage_bp)
    ...
    app.register_blueprint(snote_bp)
